...
<head>
    ...
    <title>Banking Career Hub</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <style>
        body { background: #f5f7fa; }
        .navbar { background: #0a1628 !important; }
        .navbar-brand { color: #f8c842 !important; font-weight: 700; }
...
<body>
    ...
    <div class="container mt-4">
        <div class="hero text-center">
            <h1 class="display-3 fw-bold">Banking Careers</h1>
    ...
    <div class="footer">
        <div class="container text-center">
            <p class="mb-0">🏦 Banking Career Hub © 2026</p>
        </div>
    </div>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>{{ job.name }} - Banking Career Hub</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <style>
        body { background: #f5f7fa; }
        .navbar { background: #0a1628 !important; }
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Career Match - Banking Career Hub</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <style>
        body { background: #f5f7fa; }
        .navbar { background: #0a1628 !important; }
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Resume Review - Banking Career Hub</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <style>
        body { background: #f5f7fa; }
        .navbar { background: #0a1628 !important; }
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card p-4">
                    ...
                    <p class="text-center text-muted">Upload your resume and tell us your target position. Gemini will provide editing advice and interview questions.</p>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Favorite Jobs - Banking Career Hub</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <style>
        body { background: #f5f7fa; }
        .navbar { background: #0a1628 !important; }
...
if __name__ == '__main__':
    print("=" * 60)
    print("🏦 Banking Career Hub - Flask Application")
    print("=" * 60)
