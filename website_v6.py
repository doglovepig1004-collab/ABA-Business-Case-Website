...
def calculate_match_score(job, major, grade, personality_traits):
    ...
    if "undergraduate (years 1-2)" in user_stage:
...
<head>
    ...
    <style>
        ...
        .brand-attribution { color: rgba(255,255,255,0.68); font-family: 'Montserrat', Arial, sans-serif; font-size: 0.56rem; font-weight: 700; letter-spacing: 0.13em; line-height: 1; text-transform: uppercase; }
        ...
        .role-path-traditional { background: linear-gradient(135deg, #eef3f9, #ffffff); border-color: #d8e1ed; }
        .role-path-nontraditional { background: linear-gradient(135deg, #fff7d8, #ffffff); border-color: #f1d875; }
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="/"><span class="brand-icon">🏦</span><span class="brand-copy"><span class="brand-title">Banking on the <span class="brand-highlight">Future</span></span><span class="brand-attribution">American Bankers Association</span></span></a>
    ...
    <div class="container mt-4 flex-grow-1">
        ...
        <section class="role-path-panel" aria-labelledby="choose-role-path">
            <div class="text-center">
                ...
                <p class="text-muted mb-0">Banking needs more than finance majors. Choose a path to quickly explore roles that match your interests and skills.</p>
            </div>
            <div class="role-path-options">
                <a class="role-path-button role-path-traditional" href="#traditional-banking">
                    <span class="role-path-icon" aria-hidden="true">🏦</span>
                    <span>
                        <span class="role-path-label">Traditional Banking Roles</span>
                        <span class="role-path-description">Explore client-facing, lending, markets, risk, compliance, and product roles.</span>
                    </span>
                </a>
                <a class="role-path-button role-path-nontraditional" href="#nontraditional-banking">
                    <span class="role-path-icon" aria-hidden="true">✦</span>
                    <span>
                        <span class="role-path-label">Back Office / Non-Traditional Banking Roles</span>
                        <span class="role-path-description">Discover opportunities in technology, operations, data, finance, support, and emerging specialties.</span>
                    </span>
                </a>
            </div>
        </section>
...
<body>
    ...
    <div class="container mt-4 flex-grow-1">
        ...
        <div class="card p-4">
            ...
            {% if job.career_path or job.interview_questions %}
            <div class="career-details row g-4">
                {% if job.career_path %}
                <div class="col-lg-6">
                    <h5>Career Path</h5>
                ...
                <div class="col-lg-6">
                    <h5>Questions You May Be Asked</h5>
...
<head>
    ...
    <style>
        ...
        .quiz-header h1 { margin: 0; font-family: 'Montserrat', Arial, sans-serif; font-size: clamp(1.55rem, 4vw, 2.15rem); font-weight: 800; }
...
<head>
    ...
    <style>
        ...
        .aba-talent-title { max-width: 650px; margin-bottom: 0.8rem; font-family: 'Montserrat', Arial, sans-serif; font-size: clamp(1.7rem, 4vw, 2.5rem); font-weight: 800; line-height: 1.12; }
...
def index():
    ...
    category_details = [
        {
            ...
            "name": "Traditional Banking Roles",
            "description": "Client, revenue, risk, compliance, product, and strategy career paths.",
            "offices": [
        ...
        {
            "id": "nontraditional-banking",
            "name": "Back Office / Non-Traditional Banking Roles",
            "description": "Career paths for people interested in technology, operations, analytics, business support, and emerging areas of banking.",
            "offices": [
    ...
    for category in category_details:
        groups = [
            ...
            for name, description in category["offices"]
        ]
